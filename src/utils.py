...
def load_image(image, image_size=224):
    """Handle both PIL Image and file path input for Hugging Face or CLI"""
    ...
    elif isinstance(image, Image.Image):  # Already PIL (from Gradio)
